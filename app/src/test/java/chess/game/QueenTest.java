...
public class QueenTest {
    ...
    public void testValidRookMove() {
        ...
        assertTrue(whiteQueen.isPseudoLegalMove(new Position(3, 7), board, 1));
        // Move queen vertically to (0, 3)
        assertTrue(whiteQueen.isPseudoLegalMove(new Position(0, 3), board, 1));
        // Black queen: horizontally to (4, 0)
        assertTrue(blackQueen.isPseudoLegalMove(new Position(4, 0), board, 1));
        // Black queen: vertically to (7, 4)
        assertTrue(blackQueen.isPseudoLegalMove(new Position(7, 4), board, 1));
    }

    @Test
    public void testValidBishopMove() {
        // Move queen diagonally to (0, 0)
        assertTrue(whiteQueen.isPseudoLegalMove(new Position(0, 0), board, 1));
        // Move queen diagonally to (2, 2)
        assertTrue(whiteQueen.isPseudoLegalMove(new Position(2, 2), board, 1));
        // Black queen: diagonally to (7, 7)
        assertTrue(blackQueen.isPseudoLegalMove(new Position(7, 7), board, 1));
        // Black queen: diagonally to (1, 1)
        assertTrue(blackQueen.isPseudoLegalMove(new Position(5, 5), board, 1));
    }

    @Test
    public void testInvalidMoveNotRookOrBishop() {
        // Move queen to (2, 5) which is not a straight or diagonal move
        assertFalse(whiteQueen.isPseudoLegalMove(new Position(2, 5), board, 1));
        // Black queen to (6, 5) which is not a straight or diagonal move
        assertFalse(blackQueen.isPseudoLegalMove(new Position(6, 5), board, 1));
    }

    @Test
    public void testMoveToSamePosition() {
        // Move queen to its own position
        assertFalse(whiteQueen.isPseudoLegalMove(new Position(3, 3), board, 1));
        // Black queen to its own position
        assertFalse(blackQueen.isPseudoLegalMove(new Position(4, 4), board, 1));
    }
    ...
    public void testMoveBlockedBySameColorPiece() {
        ...
        assertFalse(whiteQueen.isPseudoLegalMove(new Position(3, 5), board, 1));
        // Place a black piece at (4, 2)
        board[4][2] = new DummyPiece(new Position(4, 2), Color.Black);
        assertFalse(blackQueen.isPseudoLegalMove(new Position(4, 2), board, 1));
    }
    ...
    public void testMoveCapturesOpponentPiece() {
        ...
        assertTrue(whiteQueen.isPseudoLegalMove(new Position(3, 5), board, 1));
        // Place a white piece at (4, 2)
        board[4][2] = new DummyPiece(new Position(4, 2), Color.White);
        assertTrue(blackQueen.isPseudoLegalMove(new Position(4, 2), board, 1));
    }
    ...
    public void testMoveBlockedByPieceInPath() {
        ...
        assertFalse(whiteQueen.isPseudoLegalMove(new Position(3, 7), board, 1));
        // Place a piece between black queen and target
        board[4][2] = new DummyPiece(new Position(4, 2), Color.White);
        // Black queen tries to move to (4, 0) but path is blocked at (4, 2)
        assertFalse(blackQueen.isPseudoLegalMove(new Position(4, 0), board, 1));
    }
}